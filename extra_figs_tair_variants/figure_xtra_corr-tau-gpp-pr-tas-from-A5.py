...
#--------------------------------------------------
# plot tau_c-gpp correlation controlled for precip
#--------------------------------------------------
...
#-------------------------------------------------------
# plot tau_c-gpp correlation controlled for temperature
#-------------------------------------------------------
...
plt.savefig(co_settings['fig_settings']['fig_dir'] + 'xtra_fig_' + fig_num + co_settings['exp_suffix'] + '.' + fig_set['fig_format'],
            bbox_inches='tight',
