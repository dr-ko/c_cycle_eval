...
def get_fitted_data(_xDat,
    ...
    for _tr in range(len(_aridity_bounds) - 1):
        ...
        _yDat_tr = _yDat[mod_tasp_tmp]
        _xDat_tr = _xDat[mod_tasp_tmp]
...
mod_tasp_0 = all_mod_dat_tasp['lpj']
    ...
    for c_soil in c_soils_sel:
        ...
        for c_veg in c_veg_sel:
            ...
            for gpp in gpp_sel:
                ...
                mod_tasp = np.copy(mod_tasp_0)
                mod_pr = np.copy(mod_pr_0)
                mod_pr, mod_gpp, mod_arI, mod_tasp, mod_tau_c = _apply_common_mask_g(
                    mod_pr, mod_gpp, arI, mod_tasp, mod_tau_c)
