...
all_mod_dat_tasp75 = _get_data('tasp75', co_settings, _co_mask=all_mask)
...
all_mod_dat_tasp75['obs'] = all_mod_dat_tasp75['lpj']
...
for rel in rela_tions.keys():
    ...
    for row_m in range(nmodels):
        ...
        for _tr in range(len(_aridity_bounds) - 1):
            tasp751 = _aridity_bounds[_tr]
            tasp752 = _aridity_bounds[_tr + 1]
            mod_x_tmp = np.ma.masked_inside(mod_arI, tasp751, tasp752).mask
