...
mod_wai, mod_arI, mod_tas, mod_pr = _apply_common_mask_g(
    mod_wai, mod_arI, mod_tas, mod_pr)
# print(mod_gpp.shape)
...
for _tr in range(len(_aridity_bounds) - 1):
    ...
    _xDat_tr = mod_tas[mod_tas_tmp]
    _yDat_tr = mod_pr[mod_tas_tmp]
    _zDat_tr = mod_wai[mod_tas_tmp]
    mevery = 1
